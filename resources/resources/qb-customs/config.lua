...
bennyGarages = {
    [1] = {coords = vector4(-210.45, -1323.14, 30.22, 327.43)},
    [2] = {coords = vector4(-35.13, -1052.43, 27.72, 354.7)},
    [3] = {coords = vector4(109.89, 6627.07, 31.78, 221.7938), useJob = true, job = {"mechanic"}},
    [4] = {coords = vector4(539.79, -179.2, 53.81, 266.28)},
...
bennyLocations = {
    [1] = {coords = vector4(-35.13, -1052.43, 27.72, 354.7)},
